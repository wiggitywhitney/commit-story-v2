  ...
  return tracer.startActiveSpan('commit_story.summary.trigger_auto_summaries', async (span) => {
    try {
      ...
      if (unsummarizedDays != null) {
        span.setAttribute('commit_story.summary.day_count', unsummarizedDays.length);
      }
  ...
  return tracer.startActiveSpan('commit_story.summary.trigger_auto_weekly_summaries', async (span) => {
    try {
      ...
      if (unsummarizedWeeks != null) {
        span.setAttribute('commit_story.summary.week_count', unsummarizedWeeks.length);
      }
  ...
  return tracer.startActiveSpan('commit_story.summary.trigger_auto_monthly_summaries', async (span) => {
    try {
      ...
      if (unsummarizedMonths != null) {
        span.setAttribute('commit_story.summary.month_count', unsummarizedMonths.length);
      }
