...
export async function triggerAutoSummaries(basePath = '.', options = {}) {
  return tracer.startActiveSpan('commit_story.auto_summarize.trigger_all', async (span) => {
    try {
      ...
      span.setAttribute('commit_story.summarize.generated_count', combined.generated.length);
      span.setAttribute('commit_story.summarize.failed_count', combined.failed.length);
