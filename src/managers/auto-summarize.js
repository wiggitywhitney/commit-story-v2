...
export async function triggerAutoSummaries(basePath = '.', options = {}) {
  return tracer.startActiveSpan('commit_story.summarize.trigger_auto_summaries', async (span) => {
    try {
      ...
      span.setAttribute('commit_story.summarize.generated_count', combinedResult.generated.length);
      span.setAttribute('commit_story.summarize.failed_count', combinedResult.failed.length);
