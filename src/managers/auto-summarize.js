  ...
  return tracer.startActiveSpan('commit_story.journal.trigger_auto_summaries', async (span) => {
    try {
      ...
      if (result.failed.length > 0) {
        ...
        span.setAttribute('commit_story.summary.entry_count', result.generated.length);
        span.setAttribute('commit_story.journal.errors_count', result.errors.length);
        return result;
      }
      ...
      span.setAttribute('commit_story.summary.entry_count', result.generated.length + weeklyResult.generated.length + monthlyResult.generated.length);
      span.setAttribute('commit_story.journal.errors_count', result.errors.length + weeklyResult.errors.length + monthlyResult.errors.length);
