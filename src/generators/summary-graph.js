...
export async function dailySummaryNode(state) {
  return tracer.startActiveSpan('commit_story.journal.daily_summary_node', async (span) => {
    try {
      ...
      span.setAttribute('commit_story.journal.entry_date', date != null ? date : '');
      span.setAttribute('commit_story.journal.entries_count', entries != null ? entries.length : 0);
...
export async function weeklySummaryNode(state) {
  return tracer.startActiveSpan('commit_story.journal.weekly_summary_node', async (span) => {
    try {
      ...
      span.setAttribute('commit_story.journal.week_label', weekLabel != null ? weekLabel : '');
      span.setAttribute('commit_story.journal.daily_summaries_count', dailySummaries != null ? dailySummaries.length : 0);
...
export async function monthlySummaryNode(state) {
  return tracer.startActiveSpan('commit_story.journal.monthly_summary_node', async (span) => {
    try {
      ...
      span.setAttribute('commit_story.journal.month_label', monthLabel != null ? monthLabel : '');
      span.setAttribute('commit_story.journal.daily_summaries_count', weeklySummaries != null ? weeklySummaries.length : 0);
