...
export async function dailySummaryNode(state) {
  return tracer.startActiveSpan('commit_story.summary.generate_daily_node', async (span) => {
    try {
...
export async function weeklySummaryNode(state) {
  return tracer.startActiveSpan('commit_story.summary.generate_weekly_node', async (span) => {
    try {
...
export async function monthlySummaryNode(state) {
  return tracer.startActiveSpan('commit_story.summary.generate_monthly_node', async (span) => {
    try {
