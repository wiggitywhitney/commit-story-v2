...
async function summaryNode(state) {
  return tracer.startActiveSpan(
    'commit_story.journal.generate_summary',
    async (span) => {
...
${sectionPrompt}`;
        ...
        span.setAttribute('commit_story.journal.has_chat_context', hasChat);
...
async function technicalNode(state) {
  return tracer.startActiveSpan(
    'commit_story.journal.generate_technical_decisions',
    async (span) => {
...
async function dialogueNode(state) {
  return tracer.startActiveSpan(
    'commit_story.journal.generate_dialogue',
    async (span) => {
      try {
