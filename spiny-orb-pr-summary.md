...
|------|--------|-------|----------|------|-----------|-------------------|
| src/collectors/claude-collector.js | success | 1 | 1 | $0.22 | — | `span.commit_story.context.collect_messages` |
| src/collectors/git-collector.js | success | 6 | 2 | $0.43 | — | `span.commit_story.git.run_git`, `span.commit_story.git.get_commit_metadata`, `span.commit_story.git.get_commit_diff`, `span.commit_story.git.get_merge_info`, `span.commit_story.git.get_previous_commit_time`, `span.commit_story.git.get_commit_data`, `commit_story.git.command`, `commit_story.git.parent_count`, `commit_story.git.is_merge` |
| src/integrators/context-integrator.js | success | 1 | 1 | $0.24 | — | `span.commit_story.context.gather_context_for_commit` |
| src/generators/journal-graph.js | success | 4 | 2 | $0.72 | `@traceloop/instrumentation-langchain` | `span.commit_story.journal.summary_node`, `span.commit_story.journal.technical_node`, `span.commit_story.journal.dialogue_node`, `span.commit_story.journal.generate_sections` |
| src/generators/summary-graph.js | success | 6 | 1 | $0.52 | `@traceloop/instrumentation-langchain` | `span.commit_story.journal.daily_summary_node`, `span.commit_story.journal.generate_daily_summary`, `span.commit_story.journal.weekly_summary_node`, `span.commit_story.journal.generate_weekly_summary`, `span.commit_story.journal.monthly_summary_node`, `span.commit_story.journal.generate_monthly_summary`, `commit_story.journal.entries_count`, `commit_story.journal.week_label`, `commit_story.journal.daily_summaries_count`, `commit_story.journal.month_label`, `commit_story.journal.weekly_summaries_count` |
| src/mcp/tools/context-capture-tool.js | success | 1 | 1 | $0.14 | — | `span.commit_story.context.save_context` |
| src/mcp/server.js | success | 1 | 1 | $0.05 | `@traceloop/instrumentation-mcp`, `@opentelemetry/instrumentation-pino` | `span.commit_story.mcp.server_start`, `commit_story.mcp.transport` |
| src/utils/journal-paths.js | success | 1 | 1 | $0.20 | — | `span.commit_story.journal.ensure_directory` |
| src/managers/journal-manager.js | success | 2 | 1 | $0.49 | — | `span.commit_story.journal.save_journal_entry`, `span.commit_story.journal.discover_reflections` |
| src/managers/summary-manager.js | partial (12/14 functions) | 7 | 2 | $1.91 | — | `span.commit_story.journal.read_day_entries`, `span.commit_story.journal.save_daily_summary`, `span.commit_story.journal.generate_and_save_daily_summary`, `span.commit_story.journal.save_weekly_summary`, `span.commit_story.journal.generate_and_save_weekly_summary`, `span.commit_story.journal.save_monthly_summary`, `span.commit_story.journal.monthly_summary_pipeline` |
| src/commands/summarize.js | success | 3 | 2 | $1.21 | — | `span.commit_story.journal.run_summarize`, `commit_story.journal.dates_count`, `commit_story.journal.force`, `span.commit_story.journal.run_weekly_summarize`, `commit_story.journal.weeks_count`, `span.commit_story.journal.run_monthly_summarize`, `commit_story.journal.months_count`, `commit_story.journal.generated_count`, `commit_story.journal.failed_count` |
| src/utils/summary-detector.js | success | 9 | 1 | $0.42 | — | `span.commit_story.journal.get_days_with_entries`, `span.commit_story.journal.get_summarized_days`, `span.commit_story.journal.find_unsummarized_days`, `span.commit_story.journal.get_days_with_daily_summaries`, `span.commit_story.journal.get_summarized_weeks`, `span.commit_story.journal.find_unsummarized_weeks`, `span.commit_story.journal.get_summarized_months`, `span.commit_story.journal.get_weeks_with_weekly_summaries`, `span.commit_story.journal.find_unsummarized_months` |
| src/managers/auto-summarize.js | success | 3 | 1 | $0.23 | — | `span.commit_story.journal.trigger_auto_summaries`, `span.commit_story.journal.trigger_auto_weekly_summaries`, `span.commit_story.journal.trigger_auto_monthly_summaries` |
| src/index.js | success | 2 | 1 | $0.45 | — | `span.commit_story.journal.handle_summarize`, `span.commit_story.cli.main`, `commit_story.cli.subcommand` |
...
| | Ceiling | Actual |
|---|---------|--------|
| **Cost** | $72.54 | $7.38 (claude-sonnet-4-6) |
| **Input tokens** | 3,100,000 | 213,489 |
| **Output tokens** | — | 286,692 |
| **Cache read tokens** | — | 480,526 |
| **Cache write tokens** | — | 610,950 |

Model: `claude-sonnet-4-6` | Files: 31 | Total file size: 209,572 bytes

## Live-Check Compliance

Live-Check: OK (657 spans, 4462 advisory findings — see compliance report)
